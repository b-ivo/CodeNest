...
export default function Login() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "radial-gradient(circle at 0% 0%, rgba(22, 21, 80, 1) 0%, rgba(15, 23, 42, 1) 100%)",
      }}
    >
      {/* Decorative Orbs */}
        ...
        <div className="hidden md:flex md:w-1/2 premium-gradient p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="z-10">
            ...
            <p className="text-white/70 text-xl font-medium max-w-sm">
              Manage your courses, track your grades, and connect with your education in a whole new way.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <button type="button" className="text-xs font-bold text-primary hover:text-secondary">Forgot Password?</button>
                </div>
                <Input
                  placeholder="••••••••"
                  type="password"
              ...
              <Button type="submit" disabled={loading} className="w-full h-12 rounded-xl text-lg font-bold">
